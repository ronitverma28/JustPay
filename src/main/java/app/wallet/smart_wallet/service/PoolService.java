...
public class PoolService {
    ...
    public PoolResponse createPool(CreatePoolRequest request) {
        ...
        return com.smartwallet.util.EntityMapper.toPoolResponse(savedPool);
    }
    ...
    public PoolResponse addMember(Long poolId, Long userId) {
        ...
        return com.smartwallet.util.EntityMapper.toPoolResponse(updatedPool);
    }
    ...
    public PoolResponse getPoolDetails(Long poolId) {
        ...
        return com.smartwallet.util.EntityMapper.toPoolResponse(pool);
    }
